...
export const buscarPerguntasERespostasLider = async (req: Request, res: Response) => {
  ...
  try {
    ...
    const respostasAgrupadas: { [key: string]: string[] } = {};
